// // Importations
// const bookToBuyController = require("../controllers/bookToBuy.controller copy");
...
// bookToBuyRouter
//     .route("/getAll")
//     .get(authController, bookToBuyController.getAllBook)
//     .all((req, res) => {
...
// bookToBuyRouter
//     .route("/get/:bookID")
//     .get(authController, bookToBuyController.getBook)
//     .all((req, res) => {
//         res.status(405).send("Unavailable");
//     });
...
// bookToBuyRouter
//     .route("/create")
//     .post(authController, upload.single("imageUrl"), bookToBuyController.createBook)
//     .all((req, res) => {
//         res.status(405).send("Unavailable");
//     });
